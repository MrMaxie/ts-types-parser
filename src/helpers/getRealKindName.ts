...
export type realKindName = typeof realKindName;

export const getRealKindName = (id: number) => {
    for (const [name, currId] of Object.entries(realKindName)) {
        if (id === currId) {
            return name;
        }
    }
